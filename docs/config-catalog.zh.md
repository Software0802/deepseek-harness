...
需要：`agentDefaultModel` · `agents` · `attachments` · `directoryPicker` · `llm` · `sessions` · `subagents` · `sessionQuery` · `tools` · `userQuestions` · `workspaceRegistry` · `settings` · `credentials` · `fs` · `skills` · `systemPrompt`
...
来源：[`packages/omp/omp-advisor/src/index.ts:34`](../packages/omp/omp-advisor/src/index.ts)
...
来源：[`packages/omp/omp-loop/src/index.ts:31`](../packages/omp/omp-loop/src/index.ts)
