...
export type DesktopUpdatePhase = 'development' | 'idle' | 'checking' | 'available' | 'downloading' | 'ready' | 'up-to-date' | 'error';
 ...
 */
export declare function desktopBridge(): DesktopRendererBridge | undefined;
