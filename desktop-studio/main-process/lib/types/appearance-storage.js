...
export const DEFAULT_APPEARANCE = Object.freeze({
    ...
    focusY: 50,
    glassStrength: 72,
    palette: Object.freeze(['#587ac2', '#253555', '#d9e5f7', '#8ba5d6']),
});
...
function imageDataUrl(value) {
    ...
    if (!/^[A-Za-z0-9+/]*={0,2}$/u.test(encoded))
        throw new Error('desktop background contains invalid base64 data');
...
function builtinTheme(value, image) {
    if (value === undefined)
        return image === null ? 'whale-maid' : null;
    if (value === null) {
        if (image === null)
            throw new Error('custom desktop appearance must contain a WebP image');
        return null;
    }
    ...
    if (image !== null)
        throw new Error('bundled desktop appearance must not contain a custom image');
    return value;
}
...
export function parseAppearance(value) {
    if (typeof value !== 'object' || value === null)
        throw new Error('desktop appearance must be an object');
    const input = value;
...
//# sourceMappingURL=appearance-storage.js.map