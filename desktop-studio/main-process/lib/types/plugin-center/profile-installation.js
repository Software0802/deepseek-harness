...
import { loadProfile, readProfileBundleState, readProfileManifest, reconcileProfileBundles, resolveBundleDir, } from '@deepseek-ai/dsh-app-boot';
...
export async function reconcileAndValidateInstalledBundle(input) {
    ...
    if (reconciliation.changed) {
        await writeFileAtomic(join(input.profileDirectory, 'package.json'), `${JSON.stringify(reconciliation.manifest, null, 2)}\n`, { mode: 0o600, dirMode: 0o700 });
    }
...
//# sourceMappingURL=profile-installation.js.map