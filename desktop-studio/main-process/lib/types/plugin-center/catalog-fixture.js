...
function preflight(summary, packageName, values) {
    const artifact = values.artifact;
    const artifacts = summary.scope === 'public' && artifact !== undefined
        ? ['darwin-arm64', 'win32-x64'].map(platform => ({
            platform,
...
export const BUNDLED_CATALOG = decodeCatalogSnapshot({
    schemaVersion: 1,
    etag: CATALOG_ETAG,
...
//# sourceMappingURL=catalog-fixture.js.map