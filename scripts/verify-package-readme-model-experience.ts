...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/grok': { kind: 'indirect', reason: 'The bundle is a patch-list carrier plus a frozen package catalog; tool-imagine and tool-monitor own the model-facing text they insert.' },
