...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/omp': { kind: 'indirect', reason: 'The bundle is a patch-list carrier plus a frozen package catalog; omp-loop and omp-advisor own the model-facing text they insert.' },
