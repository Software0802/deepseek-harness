...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmOAuthMethod: 'llm-streaming.md',
  LlmOAuthDeviceCode: 'llm-streaming.md',
  LlmOAuthBeginResult: 'llm-streaming.md',
  LlmOAuthStatus: 'llm-streaming.md',
  LlmOAuthFlows: 'llm-streaming.md',
