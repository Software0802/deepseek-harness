...
import {
  ...
  llmOauthBeginValueSchema, llmOauthCancelValueSchema, llmOauthPollValueSchema,
...
export interface IApiClient {
  ...
  llm: {
    ...
    oauthBegin(payload: RequestPayload<'llm.oauthBegin'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'llm.oauthBegin'>>>
