...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('oauth-begin-failed'), message: z.string(), details: z.object({ settingsNs: z.string(), provider: z.string() }) }),
  z.object({ code: z.literal('oauth-poll-failed'), message: z.string(), details: z.object({ settingsNs: z.string() }) }),
  z.object({ code: z.literal('oauth-cancel-failed'), message: z.string(), details: z.object({ settingsNs: z.string() }) }),
